...
import com.common.components.baseUrl
...
//      httpClient.addNetworkInterceptor(RequestInterceptor())
    ...
    @Provides
    @Singleton
    internal fun provideExampleApiService(retrofit: Retrofit): ComponentsflowService {
        return retrofit.create(ComponentsflowService::class.java)
    }
}